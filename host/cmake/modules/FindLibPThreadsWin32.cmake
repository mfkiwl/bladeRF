...
if ( WIN32 )
    if ( MSVC )
	    if ( CMAKE_CL_64 )
            ...
            set ( LIBPTHREADSWIN32_LIBRARY_PATH_SUFFIX lib/x68 )
        endif ( CMAKE_CL_64 )
    ...
    if ( PTHREAD_LIBRARY )
        message(STATUS "Found win32 pthread library at ${PTHREAD_LIBRARY}")
...
if ( NOT LIBPTHREADSWIN32_FOUND )
	message ( FATAL_ERROR "win32-pthread not found - is it installed? If you're using a binary distribution, try setting -DLIBPTHREADSWIN32_PATH=<path_to_win_pthread_files>." )
